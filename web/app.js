...
const sourceFrameCtx = sourceFrame.getContext('2d', { alpha: false, willReadFrequently: true });
const compositor = document.createElement('canvas');
compositor.width = remote.width;
compositor.height = remote.height;
const compositorCtx = compositor.getContext('2d', { alpha: true, willReadFrequently: true });
const swapLayer = document.createElement('canvas');
swapLayer.width = remote.width;
swapLayer.height = remote.height;
const swapCtx = swapLayer.getContext('2d', { alpha: true, willReadFrequently: true });
let latestFaces = [];
...
let targetCtx = targetCanvas.getContext('2d', { alpha: true, willReadFrequently: true });
const swapMask = document.createElement('canvas');
swapMask.width = remote.width;
swapMask.height = remote.height;
const swapMaskCtx = swapMask.getContext('2d', { alpha: true, willReadFrequently: true });
